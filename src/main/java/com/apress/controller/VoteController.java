...
public class VoteController {
    ...
    public ResponseEntity<?> createVote(@PathVariable Long pollId, @RequestBody Vote vote) {
        ...
        responHeaders.setLocation(ServletUriComponentsBuilder
                                            .fromCurrentRequest()
                                            .path("/{id}")
    ...
    @GetMapping("/polls/{pollId}/votes/all")
    public ResponseEntity<Iterable<Vote>> getVotesAll(@PathVariable Long pollId) {
